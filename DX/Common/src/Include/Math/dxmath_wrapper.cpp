...
namespace Math {
    ...
    //----------------------------------------------------------------------
    Vector4Int::Vector4Int( I32 value )
        : XMINT4( value, value, value, value )
    {
    }

    //----------------------------------------------------------------------
    Vector4Int::Vector4Int( I32 x, I32 y, I32 z, I32 w )
        : XMINT4( x, y, z, w )
    {
    }

    //----------------------------------------------------------------------
    Vector4Int::Vector4Int( const std::array<I32, 4>& arr )
        : XMINT4( arr[0], arr[1], arr[2], arr[3])
    {
    }
